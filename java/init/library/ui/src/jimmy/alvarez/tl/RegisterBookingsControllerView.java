 ...
 * @date 11/8/23
 */
public class RegisterBookingsControllerView extends Controller {
    ...
    public void postNewBooking(ActionEvent event) {
        try {
            ...
            Response responseGestor = gestorReserva.registrar((Reserva) responseFX.getBody());

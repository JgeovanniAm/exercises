 ...
 * @date 11/8/23
 */
public class RegisterBooksControllerView extends Controller {
    ...
    public void postNewBook(ActionEvent event) {
        try {
            ...
            Response responseGestor = gestorInventario.registrar((Inventario) responseFX.getBody());

...
public class UtilDAO<T> {
     ...
     *
     * @param query this parameter means, we will receive and run the SQL query
     * @return
     */

    public static Response executeQueries(ConnectionDB connectioDB, String query, Object... params) {
     ...
     * This methods ia generic method to use in anywhere
     *
     * @param viewName this parameter means, we will receive and run the SQL query
     * @return
     */
    public static Response executeViews(ConnectionDB connectioDB, String viewName) {
        Response<ArrayList<Table>> response = new Response();
        try {
            ArrayList<Table> registers = new ArrayList<>();
            Connection dbConnection = connectioDB.connect();
     ...
     * @return
     */
    public static Response executeProcedure(ConnectionDB connectioDB, String storeProcedure, Object... params) {
